...
<asp:Content ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:FormView runat="server" ID="FormViewUserDetails" ItemType="YoutubePlaylists.Data.Models.User" SelectMethod="FormViewUserDetails_SelectData" UpdateMethod="Update">
        <EditItemTemplate>
            <div class="col-lg-12">
                <div class="form-horizontal">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="TextBoxFirstName" CssClass="form-control" Text="<%#: BindItem.FirstName %>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="TextBoxLastName" CssClass="form-control" Text="<%#: BindItem.LastName %>"/>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="TextBoxImageUrl" CssClass="form-control" TextMode="Url" Text="<%#: BindItem.ImageUrl %>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="TextBoxFacebookUrl" CssClass="form-control" TextMode="Url" Text="<%#: BindItem.FacebookUrl %>"/>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-md-10">
                            <asp:TextBox runat="server" ID="TextBoxYoutubeUrl" CssClass="form-control" TextMode="Url" Text="<%#: BindItem.FacebookUrl %>"/>
                        </div>
                    </div>
                    <div class="form-group">
