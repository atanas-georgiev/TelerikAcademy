...
namespace LibrarySystem.Data.Migrations
{
    public sealed class Configuration : DbMigrationsConfiguration<LibrarySystemDbContext>
    {
        ...
        protected override void Seed(LibrarySystemDbContext context)
        {
            ...
            this.SeedBooksAndCategories(context);
            base.Seed(context);
        }

        private void SeedBooksAndCategories(LibrarySystemDbContext context)
        {
        ...
        private void SeedUsers(LibrarySystemDbContext context)
        {
        ...
        private void SeedRoles(LibrarySystemDbContext context)
        {
